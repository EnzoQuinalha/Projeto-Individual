...
--
-- Host: localhost    Database: LiesOfP
-- ------------------------------------------------------
...
--
-- Table structure for table `avaliacoes_tierlist`
--

DROP TABLE IF EXISTS `avaliacoes_tierlist`;
...
--
-- Dumping data for table `avaliacoes_tierlist`
--

LOCK TABLES `avaliacoes_tierlist` WRITE;
/*!40000 ALTER TABLE `avaliacoes_tierlist` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `avaliacoes_tierlist` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `resultado_quiz`
--
...
--
-- Dumping data for table `resultado_quiz`
--

LOCK TABLES `resultado_quiz` WRITE;
/*!40000 ALTER TABLE `resultado_quiz` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `resultado_quiz` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2026-06-02  8:44:04
